...
def get_configs():
	...
	parser.add_argument("--data", type=str, default="residence", choices=["data", "google", "building", "rubble",
	...
	parser.add_argument("--stride_stage1", type=int, default=4, help="stride for saved images to training stage1")
