...
def get_configs():
	...
	parser.add_argument("--mode", type=str, default="earth", choices=["earth", "planes"], help="space mode select")
	parser.add_argument("--data", type=str, default="data", choices=["data", "google", "building", "rubble",
		"residence", "campus"], help="dataset select")
	parser.add_argument("--num_rays", type=int, default=512, help="number of rays or pixels for each iter")
	parser.add_argument("--num_rays_test", type=int, default=10240, help="number of rays or pixels for testing")
	...
	parser.add_argument("--hash_size", type=int, default=21, help="hash table size: 2**x")
	parser.add_argument("--grid_x", type=int, default=1, help="number of space split in x axis")
	parser.add_argument("--grid_y", type=int, default=1, help="number of space split in y axis")
	parser.add_argument("--max_rays", type=int, default=450*1000*2048, help="max rays for training in stage 0")
	parser.add_argument("--max_images", type=int, default=50*1000*2, help="max images for training in stage 1")
	parser.add_argument("--max_rays_test", type=int, default=50*1000*2048, help="max rays for get embedding on testing")
	...
	parser.add_argument("--appearance", type=bool, default=False, help="add appearance embeddings or not")
	parser.add_argument("--app_dims", type=int, default=0, help="dims of per image appearance embeddings")
	parser.add_argument("--stride_stage1", type=int, default=1, help="stride for saved images to training stage1")
