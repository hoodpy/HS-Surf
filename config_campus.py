...
def get_configs():
	...
	parser.add_argument("--data", type=str, default="campus", choices=["data", "google", "building", "rubble",
	...
	parser.add_argument("--max_rays", type=int, default=1400*1000*2048, help="max rays for training in stage 0")
	parser.add_argument("--max_images", type=int, default=100*1000*2, help="max images for training in stage 1")
	parser.add_argument("--max_rays_test", type=int, default=200*1000*2048, help="max rays for get embedding on testing")
	...
	parser.add_argument("--stride_stage1", type=int, default=9, help="stride for saved images to training stage1")
